    ...
    public function buildRegex($chars, $matchAll = true)
    {
        ...
        foreach ($chars as $char){
            if ($char == 'A') {			// Upper case ASCII letters a-z
                $regexParts[] = 'A-Z';
            } elseif ($char == 'a') {	// Lower case ASCII letters a-z
                $regexParts[] = 'a-z';
            } elseif ($char == '9') {	// Digits 0-9
                $regexParts[] = '0-9';
            } elseif ($char == '^') {	// Extended ASCII letters
                $regexParts[] = '[:print:]';
            } elseif ($char == '/') {	// Forward or backward slashes
                $regexParts[] = '/'.chr(92).chr(92);
            } elseif ($char == '(') {	// Open or close brackets
                $regexParts[] = '\(\)';
            } elseif ($char == '{') {	// Open or close curly brackets
                $regexParts[] = '\{\}';
            } elseif ($char == 'n') {	// Carriage return and line feed
                $regexParts[] = '\n\r';
            } elseif ($char == '*') {	// No restrictions
                $regexParts[] = ".";
            } else {
